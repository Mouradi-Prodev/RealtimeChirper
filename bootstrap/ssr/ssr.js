import { useSSRContext, mergeProps, unref, withCtx, createVNode, ref, onMounted, createTextVNode, withModifiers, openBlock, createBlock, toDisplayString, createCommentVNode, computed, onUnmounted, renderSlot, withDirectives, vModelText, Fragment, renderList, watch, withKeys, nextTick, createSSRApp, h as h$1 } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrLooseContain, ssrGetDynamicModelProps, ssrRenderStyle, ssrRenderClass, ssrRenderList, ssrRenderTeleport } from "vue/server-renderer";
...
const ApplicationLogo = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$s = {
  __name: "GuestLayout",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$e, {
        ...
        active: _ctx.route().current("chats.index")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Chats `);
...
const _sfc_main$b = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Chats" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$c, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight"${_scopeId}>Chats</h2>`);
          } else {
            return [
              createVNode("h2", { class: "font-semibold text-xl text-gray-800 leading-tight" }, "Chats")
            ];
          }
        }),
        _: 1
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Chats/index.vue");
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 flex space-x-2" }, _attrs))}><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 -scale-x-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg><div class="flex-1"><div class="flex justify-between items-center"><div><span class="text-gray-800">${ssrInterpolate(__props.chirp.user.name)}</span><small class="ml-2 text-sm text-gray-600">${ssrInterpolate(unref(dayjs)(__props.chirp.created_at).fromNow())}</small>`);
      if (__props.chirp.created_at !== __props.chirp.updated_at) {
        _push(`<small class="text-sm text-gray-600"> · edited</small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (__props.chirp.user.id === _ctx.$page.props.auth.user.id) {
        _push(ssrRenderComponent(_sfc_main$g, null, {
          ...
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_sfc_main$f, {
                as: "button",
                href: _ctx.route("chirps.destroy", __props.chirp.id),
                method: "delete"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
      ...
      _push(`</div>`);
      if (editing.value) {
        _push(`<form><textarea class="mt-4 w-full text-gray-900 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">${ssrInterpolate(unref(form).message)}</textarea>`);
        _push(ssrRenderComponent(_sfc_main$r, {
          message: unref(form).errors.message,
          class: "mt-2"
        }, null, _parent));
        _push(`<div class="space-x-2">`);
        _push(ssrRenderComponent(_sfc_main$p, { class: "mt-4" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Save`);
            } else {
        ...
        _push(`<p class="mt-4 text-lg text-gray-900">${ssrInterpolate(__props.chirp.message)}</p>`);
      }
      _push(`</div></div>`);
    };
  }
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Chirp/Chirp.vue");
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Chirps" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$c, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight"${_scopeId}>Chirps</h2>`);
          } else {
            return [
              createVNode("h2", { class: "font-semibold text-xl text-gray-800 leading-tight" }, "Chirps")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8"${_scopeId}><form${_scopeId}><textarea placeholder="What&#39;s on your mind?" class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"${_scopeId}>${ssrInterpolate(unref(form).message)}</textarea>`);
            _push2(ssrRenderComponent(_sfc_main$r, {
              message: unref(form).errors.message,
              class: "mt-2"
            }, null, _parent2, _scopeId));
            ...
            ssrRenderList(__props.chirps, (chirp) => {
            ...
            return [
              createVNode("div", { class: "max-w-2xl mx-auto p-4 sm:p-6 lg:p-8" }, [
                ...
                createVNode("div", { class: "mt-6 bg-white shadow-sm rounded-lg divide-y" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.chirps, (chirp) => {
